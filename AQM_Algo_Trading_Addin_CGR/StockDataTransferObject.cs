...
namespace AQM_Algo_Trading_Addin_CGR
{
    class StockDataTransferObject
    {
        ...
        public static int posTimestampPrice     = 5;
        public static int posPrice              = 6;
        public static int posTimestampVolume    = 7;
        public static int posVolume             = 8;
        public static int posTrendAbs           = 9;
        public static int posTrendPerc          = 10;
        public static int posOpen               = 11;
        public static int posPreDayClose        = 12;
        public static int posAdjClose           = 13;
        public static int posHigh               = 14;
        public static int posLow                = 15;
        public static int posTotalVolume        = 16;
